...
export default function BudgetRequestApproval({ id }: Props) {
  ...
  const saveSignedDocument = async () => {
    ...
    try {
      ...
      if (pageRef.current) {
        const rect = pageRef.current.getBoundingClientRect();
        console.log('[Academic Coordinator E-Sign] Saving NEW signatures with container info:', {
        ...
        >
          ...
          >
            ...
            <div className="flex-1">
              <h1 className="text-lg font-semibold text-gray-900 tracking-tight">Budget Request Approval (Academic Coordinator)</h1>
        ...
        <div className="flex flex-1 pb-8">
          ...
          <div className="w-96 p-6">
            <div className="space-y-6">
              ...
              >
                <h3 className="text-lg font-semibold text-gray-900 mb-4">E-Signature (Academic Coordinator)</h3>
