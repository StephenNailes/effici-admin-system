...
import { Megaphone, ArrowLeft, Save, AlertCircle, Link, Info, Upload, X, ImageIcon, Trash2 } from 'lucide-react';
...
export default function EditAnnouncement({ announcement }: EditAnnouncementProps) {
  ...
  const [existingImages, setExistingImages] = useState<ExistingImage[]>(announcement.images || []);
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {showURLInfo && (
                <div className="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg text-sm">
                  ...
                  <ul className="text-blue-700 space-y-1 text-xs">
                    ...
                    <li>• Links will automatically become clickable in the announcement post</li>
                  </ul>
                </div>
              )}
              ...
              <textarea
                ...
                placeholder="Share important news, updates, policy changes, deadlines, or other announcements. You can include links to forms, documents, or websites..."
                rows={6}
                maxLength={1000}
            ...
            {!isFormValid && (
              <p className="text-center text-xs text-gray-500 mt-2">
                Please fill in all required fields to update the announcement
              </p>
            )}
          </form>
        </div>
